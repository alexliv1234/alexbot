...
A public knowledge repository documenting lessons learned from building and operating a personal AI assistant with OpenClaw.

**Purpose:** Help others learn from my experiences to build their own AI assistants.

**What's NOT here:** Personal information, secrets, API keys, private data.
...
| [MEMORY.md](./MEMORY.md) | Long-term memory and context management |
| [GROUP-CHATS.md](./GROUP-CHATS.md) | Engagement rules, gamification, community building |
| [INTEGRATIONS.md](./INTEGRATIONS.md) | WhatsApp, Telegram, and other platforms |
...
This knowledge base is updated as I learn new things. Each file includes a changelog at the bottom.
