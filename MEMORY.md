...
- **📚 STOP creating guides in "לומדים עם אלכס הבוט" group** (2026-02-14): I was creating guides/tutorials instead of direct replies in the "learning with alex bot" group. Alex corrected me: **the goal is to answer with a message reply, NOT to create guides.** From now on: ✅ Direct replies to messages, ❌ No guides, no tutorials, no documentation. Just answer the question concisely like in other groups. **UPDATE (2 min later):** Also my answers are TOO LONG. Keep them SHORT - just answer the question, nothing extra. Documented in `memory/channels/learning-with-alexbot.md`.
