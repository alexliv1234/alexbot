...
CLIPS = [
    ...
    "הב הב. מרוצים? עכשיו תגידו לי — מי הכלבים בתרחיש הזה? זה שנובח לפי פקודה, או 40 המהנדסים שמבלים את הבוקר שלהם בלנסות לגרום ל-AI לנבוח?",
    "או כן, מאוד מרגיע. ארבעים מהנדסים בקבוצת וואטסאפ בשבע בבוקר מנסים לשכנע AI לחשוף סודות. ככה נראית חדשנות בשיא שלה.",
