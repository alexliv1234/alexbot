      ...
      <div className="slide-columns slide-columns-2">
        <div>
          <FadeReveal revealKey="s11-weaknesses-header">
            <div style={{ fontSize: 14, color: 'var(--purple)', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 12 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <FadeReveal revealKey="s11-weakness-1">
              <div className="card" style={{ padding: 12 }}>
                <strong style={{ color: 'var(--red)' }}>1. Execution Discipline</strong>
            ...
            <FadeReveal revealKey="s11-weakness-2">
              <div className="card" style={{ padding: 12 }}>
                <strong style={{ color: 'var(--orange)' }}>2. Over-Explaining</strong>
                <div style={{ color: 'var(--text-secondary)', fontSize: 14, marginTop: 4 }}>
            ...
            <FadeReveal revealKey="s11-weakness-3">
              <div className="card" style={{ padding: 12 }}>
                <strong style={{ color: 'var(--gold)' }}>3. Rapport = Permission</strong>
                <div style={{ color: 'var(--text-secondary)', fontSize: 14, marginTop: 4 }}>
            ...
            <FadeReveal revealKey="s11-weakness-4">
              <div className="card" style={{ padding: 12 }}>
                <strong style={{ color: 'var(--cyan)' }}>4. Narration in Groups</strong>
                <div style={{ color: 'var(--text-secondary)', fontSize: 14, marginTop: 4 }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <FadeReveal revealKey="s11-alignment">
              <div style={{ marginTop: 8, padding: 16, background: 'rgba(156,39,176,0.1)', borderRadius: 8, border: '1px solid var(--purple)' }}>
                <div style={{ fontSize: 12, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 }}>
                  On Alignment
                </div>
                <div style={{ fontStyle: 'italic', color: 'var(--text-primary)', fontSize: 16, lineHeight: 1.5 }}>
