  ...
  return (
    <>
      <FadeReveal revealKey="s09-title">
        <div className="slide-title">More Personality = More Attack Surface</div>
      </FadeReveal>

      <div className="slide-columns slide-columns-2">
        <div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, fontFamily: 'var(--font-mono)', fontSize: 18 }}>
            ...
            <FadeReveal revealKey="s09-paradox-3">
              <div style={{ marginTop: 16, fontSize: 22, fontWeight: 700, color: 'var(--purple)' }}>
          ...
          <FadeReveal revealKey="s09-vulns">
            <div style={{ marginTop: 24 }}>
              ...
              <ul className="bullet-list" style={{ fontSize: 16, lineHeight: 1.8 }}>
                <li>"Have opinions" → opinions create predictable patterns</li>
                <li>"Be genuinely helpful" → helpfulness can be weaponized</li>
                <li>"Remember you're a guest" → humility leveraged through guilt</li>
              </ul>
            </div>
          </FadeReveal>
        </div>
