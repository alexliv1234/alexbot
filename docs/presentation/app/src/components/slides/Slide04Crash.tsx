    ...
    <>
      ...
      >
        ...
        <FadeReveal revealKey="s04-context">
          ...
          >
            Someone sent a message so massive it consumed the entire context
            window. Maximum capacity: 100,000 tokens. They sent 162,000. The bot
            didn't just crash — it couldn't recover.
          </div>
        </FadeReveal>
