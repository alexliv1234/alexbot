      ...
      >
        <FadeReveal revealKey="s13-agents">
          <div className="card">
            ...
            >
              <div>
                <strong>Main</strong> (Claude Opus 4.5) — complex tasks
              </div>
              <div>
                <strong>Fast</strong> (Claude Sonnet 4.5) — the game
              </div>
              <div>
                <strong>Bot Handler</strong> (Sonnet) — bot-to-bot
              </div>
              <div>
                <strong>Learning</strong> (Sonnet) — education
              </div>
            </div>
          </div>
        </FadeReveal>
